...
class TasksAdapter(val tasks: List<String>, val longClickListener: OnLongClickListener, val clickListener: OnClickListener) : RecyclerView.Adapter<TasksAdapter.ViewHolder>() {
